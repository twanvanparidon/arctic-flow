...
pretending to be a stream. `fake_claude` is a working program speaking the Claude Code CLI's
protocol, so the adapter really spawns a process without an account or a network.
