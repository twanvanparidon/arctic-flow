"""What is installed, and which definition of each name won.

The part worth testing is the part that answers "why is this not the one running": which
of several definitions is reported, and what it is hiding.
"""
